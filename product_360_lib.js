            ...
            7475: (t, e, n) => {
                ...
                t.exports = function (t) {
                    ...
                    return (
                        i(t) &&
                            ((e = t.constructor),
                            ((o(e) && (e === s || i(e.prototype))) || (r(e) && null === (e = e[a]))) && (e = void 0)),
                        void 0 === e ? s : e
                    );
                };
            },
                ...
                var i = n(1702),
                    ...
                    w = (t.exports = function (t, e, n) {
                        ('Symbol(' === m(f(e), 0, 7) && (e = '[' + v(f(e), /^Symbol\(([^)]*)\)/, '$1') + ']'),
                            ...
                            y && n && a(n, 'arity') && t.length !== n.arity && p(t, 'length', { value: n.arity }));
                        try {
                ...
                ((s[f] = !0),
                    (t.exports =
                        ...
                        function (t, e) {
                            var n;
                            return (
                                null !== t ? ((p[d] = o(t)), (n = new p()), (p[d] = null), (n[f] = t)) : (n = g()),
                                void 0 === e ? n : r.f(n, e)
                            );
                        }));
            },
    ...
    ((n.n = t => {
        ...
        (() => {
            ...
            var r = 'spin-y',
                ...
                d = function (t) {
                    return {
                        ...
                        amountX: parseInt(
                            f(t, 'amount') || f(t, 'data-amount') || f(t, 'amount-x') || f(t, 'data-amount-x') || 36,
                            10
                        ),
                        ...
                        bottomCircleOffset: parseInt(
                            f(t, 'bottom-circle-offset') || f(t, 'data-bottom-circle-offset') || 5,
                            10
                        ),
                ...
                R = function (t, e) {
                    ...
                    if (d) {
                        var m = r.offsetWidth,
                            ...
                            g = v ? ''.concat(v, '/') : '',
                            y =
                                ((n = ((o = m) <= 25 ? '25' : o <= 50 ? '50' : (100 * Math.ceil(o / 100)).toString())
                                    .toString()
                                    .split('x')),
                                (i = []),
                ...
                et = function (t, e, n, i) {
                    ...
                    return (
                        r > a ? (c = s / r) : (s = c * r),
                        {
                            width: s,
                            height: c,
                            offsetX: (t - s) * (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0.5),
                            offsetY: (e - c) * (arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 0.5),
                        }
                    );
                },
                nt = function (t, e, n) {
                        ...
                        (('body' !== Ct(e) || Pt(s)) &&
                            (u =
                                (i = e) !== vt(i) && yt(i)
                                    ...
                                    : St(i)),
                        yt(e) ? (((l = Et(e, !0)).x += e.clientLeft), (l.y += e.clientTop)) : s && (l.x = Lt(s))),
            ...
            function zt(t) {
                ...
                return n && ('html' === Ct(n) || ('body' === Ct(n) && 'static' === At(n).position))
                    ? e
                    : n ||
                          (function (t) {
                                        ...
                                        for (var i = 0; i < s.orderedModifiers.length; i++)
                                            if (!0 !== s.reset) {
                                                var o = s.orderedModifiers[i],
                                                    ...
                                                    d = o.name;
                                                'function' == typeof r &&
                                                    (s = r({ state: s, options: c, name: d, instance: l }) || s);
                                            } else ((s.reset = !1), (i = -1));
                                    }
                                }
                            },
            ...
            function le(t) {
                ...
                if (u) {
                    ...
                    (I === vt(n) &&
                        ...
                        (o !== _t && ((o !== Nt && o !== Vt) || r !== Ut)) ||
                            ((b = Bt),
                            (f -= (d && I === x && x.visualViewport ? x.visualViewport.width : I[k]) - i.width),
                            (f *= c ? 1 : -1)));
                }
                var E,
                ...
                return (
                    ...
                    c
                        ...
                        : Object.assign(
                              {},
                              S,
                              (((e = {})[w] = y ? m + 'px' : ''), (e[b] = g ? f + 'px' : ''), (e.transform = ''), e)
                          )
                );
            }
            const de = {
            ...
            function Oe(t, e) {
                ...
                var n = e,
                        ...
                        var o =
                                'clippingParents' === e
                                    ? (function (t) {
                                          var e = Xt(Tt(t)),
                                              n =
                                                  ['absolute', 'fixed'].indexOf(At(t).position) >= 0 && yt(t)
                                                      ? zt(t)
                                                      : t;
                                          return gt(n)
                                              ? e.filter(function (t) {
                    ...
                    O = ce({ reference: I, element: b, strategy: 'absolute', placement: o }),
                    ...
                    if (!e.modifiersData[i]._skip) {
                        for (
                            ...
                            var S = b[E],
                                ...
                                L = [Nt, Vt].indexOf(C) >= 0,
                                A = L ? 'width' : 'height',
                                P = Oe(e, { placement: S, boundary: l, rootBoundary: d, altBoundary: h, padding: u }),
                                D = L ? (j ? Bt : _t) : j ? Vt : Nt;
                            w[A] > x[A] && (D = me(D));
                            var Y = me(D),
                                T = [];
            ...
            const Se = {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            ...
                            p = n.tetherOffset,
                            m = void 0 === p ? 0 : p,
                            v = Oe(e, { boundary: c, rootBoundary: u, padding: d, altBoundary: l }),
                            g = re(e.placement),
                            y = ae(e.placement),
                            b = !y,
                            w = se(g),
                                    ...
                                    try {
                                        var v =
                                                ...
                                                document.querySelector(
                                                    '['.concat('data-cloudimage-360-hotspots', '=').concat(o, ']')
                                                )),
                                            g = v.cloneNode(!0);
                ...
                return (
                    ...
                    (i = [
                                ...
                                if (this.imagesLoaded) {
                                    ...
                                    (this.hideInitialIcons(),
                                        (this.autoplay || this.loopTimeoutId) &&
                                            (this.stop(), (this.autoplay = !1), (this.isZoomReady = !0)),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                if (this.imagesLoaded) {
                                    ...
                                    if (
                                        (this.mouseTracked &&
                                            (this.setCursorPosition(t), this.isClicked || this.update()),
                                        this.isClicked)
                                    ) {
                                        var i = { x: e, y: n };
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this.imagesLoaded &&
                                    (this.pointerZoom && this.mouseTracked && this.togglePointerZoom(),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (
                                        ...
                                        n.forEach(function (t, i) {
                                            setTimeout(
                                                function () {
                                                    ((e.zoomIntensity = t),
                                                        e.update(),
                                                        i === n.length - 1 && ((e.mouseTracked = !1), e.update()));
                                                },
                                                200 * (e.pointerZoom - t)
                                            );
                                        }));
                                    ...
                                    (this.hotspotsConfigs &&
                                        (document.querySelectorAll('[data-hotspot-icon-id]') || []).forEach(
                                            function (t) {
                                                pt(t);
                                            }
                                        ),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (
                                    ...
                                    K(this.srcXConfig, e, this.onOriginalImageLoad.bind(this, c, t)),
                                    this.allowSpinY)
                                ) {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                this.imagesLoaded &&
                                    ...
                                    27 === t.keyCode && this.mouseTracked && this.togglePointerZoom());
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                this.imagesLoaded &&
                                    ...
                                    this.allowSpinY &&
                                        (t.preventDefault(),
                                        38 === t.keyCode &&
                                            (this.keysReverse ? this.top() : this.bottom(), this.onSpin()),
                                        40 === t.keyCode &&
                                            (this.keysReverse ? this.bottom() : this.top(), this.onSpin())));
                            },
                        },
                        {
                            key: 'onSpin',
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                this.stopAtEdges
                                    ...
                                    : ((this.activeImageX = (this.activeImageX + t) % this.amountX || this.amountX),
                                ...
                                this.stopAtEdges
                                    ? this.activeImageX - t <= 1
                                        ...
                                        : ((this.activeImageX -= t),
                                          ...
                                          this.rightElem && rt(this.rightElem, 'not-active'))
                                    : this.activeImageX - t < 1
                                      ? ((this.activeImageX = this.amountX + (this.activeImageX - t)),
                                        (this.spinY = !0))
                                      : (this.activeImageX -= t);
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                this.stopAtEdges
                                    ...
                                    : ((this.activeImageY = (this.activeImageY + t) % this.amountY || this.amountY),
                                ...
                                this.stopAtEdges
                                    ? this.activeImageY - t <= 1
                                        ...
                                        : ((this.activeImageY -= t),
                                          ...
                                          this.topElem && rt(this.topElem, 'not-active'))
                                    : this.activeImageY - t < 1
                                      ? ((this.activeImageY = this.amountY + (this.activeImageY - t)),
                                        (this.spinY = !1))
                                      : (this.activeImageY -= t);
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (this.spinReverse ? this.moveActiveIndexDown(e) : this.moveActiveIndexUp(e),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (this.spinReverse ? this.moveActiveIndexUp(e) : this.moveActiveIndexDown(e),
                                    (this.activeImageY = 1),
                                    (this.movementStart.x = t),
                                    this.update());
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (this.spinReverse ? this.moveActiveYIndexUp(e) : this.moveActiveYIndexDown(e),
                                    (this.activeImageX = 1),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (this.spinReverse ? this.moveActiveYIndexDown(e) : this.moveActiveYIndexUp(e),
                                    (this.activeImageX = 1),
                                    (this.movementStart.y = t),
                                    this.update());
                            },
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                ((this.canvas.width = this.container.offsetWidth * this.devicePixelRatio),
                                    ...
                                    (this.canvas.height = (this.container.offsetWidth / n) * this.devicePixelRatio),
                                    (this.canvas.style.height = this.container.offsetWidth / n + 'px'));
                            },
                        },
                        {
                            key: 'onResizedImageLoad',
                            value: function (t, e, n) {
                                (t === u ? (this.resizedImagesY[n] = e) : (this.resizedImagesX[n] = e),
                            ...
                            value: function () {
                                if (this.isReady()) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            (q(this.srcXConfig, n, this.onResizedImageLoad.bind(this, c)),
                                            this.allowSpinY)
                                        ) {
                            ...
                            value: function (t) {
                                ...
                                ((this.isMagnifyOpen = !0),
                                    ...
                                    (function (t, e, n, i, o) {
                                        ...
                                        (i.setAttribute('class', 'cloudimage-360-img-magnifier-glass'),
                                            t.prepend(i),
                            ...
                            value: function (t, n, i) {
                                ...
                                if (
                                    ...
                                    return (
                                        ...
                                        ((s = s.cloneNode(!0)).className = s.className.replace(' initialized', '')),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t;
                                ((this.view360Icon =
                                    (((t = document.createElement('div')).className = 'cloudimage-360-view-360-icon'),
                                    (t.innerText = '0%'),
                                    t)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t;
                                ((this.fullscreenIcon =
                                    (((t = document.createElement('div')).className = 'cloudimage-360-fullscreen-icon'),
                                    t)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t;
                                ((this.magnifierIcon =
                                    (((t = document.createElement('div')).className = 'cloudimage-360-magnifier-icon'),
                                    t)),
                                    ...
                                    e = (function (t, e) {
                                        ...
                                        return (
                                            h &&
                                                ...
                                                h.addEventListener('touchstart', d ? r : a, { passive: !0 }),
                                            ...
                                            f &&
                                                ...
                                                f.addEventListener('touchstart', d ? a : r, { passive: !0 }),
                                            ...
                                            (d ? f : h) &&
                                                o &&
                                                (ot(d ? f : h, 'not-active'), ot(d ? p : m, 'not-active')),
                                            l
                                        );
                                    })(
                                        {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (
                                    ...
                                    (this.disableDrag = M),
                                    (this.fullscreen = F),
                                    (this.magnifier = !this.isMobile && z > 1 ? Math.min(z, 5) : 0),
                                    (this.lazySelector = W),
                                    (this.spinReverse = H),
                                    ...
                                    return (
                                        ...
                                        this.hide360Logo ||
                                            this.lazyload ||
                                            !this.logoSrc ||
                                            (this.add360ViewIcon(), p(this.view360Icon, this.logoSrc)),
                                        this.magnifier && this.addMagnifier(),
                                        this.bottomCircle && !this.fullscreenView && this.add360ViewCircleIcon(),
                                        this.fullscreen && !this.fullscreenView && this.addFullscreenIcon(),
                                        this.boxShadow &&
                                        ...
                                        r &&
                                            !this.fullscreenView &&
                                            ((this.hotspotsConfigs = Xe(r)), Ye(t, this.hotspotsConfigs)),
                                ...
                                ((this.innerBox = (function (t) {
                                    ...
                                    (this.canvas =
                                        ((e = this.innerBox),
                                        ((n = document.createElement('canvas')).style.width = '100%'),
                                        (n.style.fontSize = '0'),
                                        e.appendChild(n),
                                        n)),
                                    (this.loader = lt(this.innerBox)),
                                    this.hotspotsConfigs && !this.fullscreenView && Ye(t, this.hotspotsConfigs),
                                    (function (t) {
                                    ...
                                    (this.srcYConfig = Ne(
                                        Ne({}, this.srcXConfig),
                                        {},
                                        { filename: m, orientation: u, imageList: g, amount: this.amountY }
                                    )));
                                var rt = R(this.srcXConfig),
                                    at = function (t, e, n) {
                                        ...
                                        (i.updatePercentageInLoader(s),
                                            a ? i.onFirstImageLoaded(e) : i.autoplay && i.moveRight(n),
