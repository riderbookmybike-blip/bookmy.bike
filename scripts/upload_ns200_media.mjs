...
const BRAND = 'bajaj';
const MODEL = 'pulsar-ns200';
const VARIANT = 'standard';

const COLOURS = [
  { slug: 'glossy-ebony-black' },
  { slug: 'metallic-pearl-white' },
  { slug: 'cocktail-wine-red' },
  { slug: 'pewter-grey' }
];
...
async function main() {
  console.log('\n🚀 Pulsar NS200 — Uploading primary images to Supabase Storage\n');
