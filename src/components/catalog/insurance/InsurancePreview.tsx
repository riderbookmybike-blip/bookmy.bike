        ...
        <div className="flex flex-col h-full bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/40 dark:border-white/5 shadow-2xl ring-1 ring-black/5">
            ...
            <div className="bg-white/60 dark:bg-slate-800/60 p-5 border-b border-black/5 dark:border-white/5 flex justify-between items-center transition-colors">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-black text-slate-900 dark:text-white text-base tracking-tight italic uppercase">
                            Premium Simulator
                        </h3>
                ...
                <button
                    ...
                    className="text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all p-2 hover:bg-white dark:hover:bg-white/10 rounded-xl active:scale-95"
                >
                    <RefreshCw size={16} />
                </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
                ...
                <div className="bg-white/50 dark:bg-white/5 p-6 rounded-[2rem] border border-white dark:border-white/10 shadow-xl space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div className="relative group">
                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-300 text-sm font-black">
                                    ₹
                                </span>
                                <input
                                    type="number"
                                    ...
                                    onChange={e =>
                                        setInputs({ ...inputs, exShowroom: parseFloat(e.target.value) || 0 })
                                    }
                                />
                            </div>
                        </div>
                    ...
                    <div className="p-4 bg-blue-50/50 dark:bg-blue-500/10 rounded-2xl border border-blue-100 dark:border-blue-500/30 flex justify-between items-center transition-all">
                        <div>
                            <p className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest leading-none mb-1">
                                Derived IDV (Insured Declared Value)
                            </p>
                            <p className="text-xl font-black text-blue-700 dark:text-blue-300 tracking-tighter italic">
                                ₹{result?.idv.toLocaleString()}
                            </p>
                        </div>
                        <div className="text-right">
                            <p className="text-[10px] font-black text-blue-500 dark:text-blue-400 uppercase tracking-widest leading-none mb-1">
                                Logic
                            </p>
                            <p className="text-[12px] font-black text-blue-600/80 dark:text-blue-400 uppercase italic leading-none">
                                {rule.idvPercentage}% OF EX-S
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-6 px-2">
                        ...
                        <div className="space-y-3">
                            ...
                            {result.odBreakdown.map((item, id) => (
                                <div key={id} className="flex justify-between items-center">
                                    <div>
                                        <p className="text-xs font-black text-slate-700 dark:text-slate-300 uppercase italic tracking-tighter">
                                            {item.label}
                                        </p>
                                        <p className="text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-tighter italic">
                                            {item.meta}
                                        </p>
                                    </div>
                                    <p className="font-mono font-black text-xs text-slate-900 dark:text-white leading-none">
                        ...
                        <div className="mt-8 bg-gradient-to-br from-slate-900 to-indigo-950 dark:from-indigo-950 dark:to-slate-950 rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden border border-white/10">
                            ...
                            <div className="border-t border-white/10 pt-6 flex justify-between items-end">
                                ...
                                <div className="text-right">
                                    <div className="px-3 py-1 bg-white/10 rounded-full border border-white/20 text-[8px] font-black uppercase tracking-widest">
                                        Studio Validated
                                    </div>
                                </div>
                            </div>
