        ...
        <div className="w-full space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="relative">
                ...
                >
                    <div className="flex gap-3 items-center">
                        <div className={`p-3 rounded-xl transition-all duration-500 ${isModelExpanded ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-white/5 text-slate-400 group-hover:text-blue-500'}`}>
                            <Box size={22} />
                        </div>
                        <div>
                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-0.5 leading-none italic">Parent Model Entity</p>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="px-3 py-1.5 bg-slate-50 dark:bg-white/5 rounded-lg border border-slate-100 dark:border-white/5">
                            <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{variants.length} Variants</span>
                        </div>
                ...
                {isModelExpanded && (
                    <div className="mt-4 space-y-4 pl-16 animate-in slide-in-from-top-4 duration-500">
                        {variants.map((v, idx) => {
                            ...
                            return (
                                <div key={v.id} className="relative group/var">
                                    ...
                                    <div className={`bg-white dark:bg-slate-900 rounded-[1.5rem] border ${isExpandedVariant ? 'border-blue-500 shadow-2xl shadow-blue-500/10' : 'border-slate-200 dark:border-white/5'} overflow-hidden transition-all duration-500`}>
                                        {/* Variant Header Slot */}
                                        <div
                                        ...
                                        >
                                            <div className="flex items-center gap-6">
                                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black text-sm italic transition-all duration-500 shadow-inner ${isExpandedVariant ? 'bg-blue-600 text-white shadow-blue-500/40' : 'bg-slate-100 dark:bg-white/5 text-slate-300 group-hover/var:text-blue-500'}`}>
                                                    {v.name.charAt(0)}
                                                </div>
                                                <div className="flex flex-col">
                                                    <div className="flex items-center gap-2">
                                                        <input
                                                            ...
                                                            onChange={(e) => onUpdateVariant(v.id, 'name', e.target.value)}
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="hidden xl:flex items-center gap-6 mr-4 border-l border-slate-100 dark:border-white/5 pl-6">
                                                    <div className="text-right">
                                                        <p className="text-[7px] font-black text-slate-400 uppercase tracking-[0.2em] mb-0.5">Distribution</p>
                                                        <p className="text-[10px] font-black text-slate-600 dark:text-slate-300 uppercase italic">14 Dealers</p>
                                                    </div>
                                                    <div className="text-right">
                                                ...
                                                <button
                                                    onClick={(e) => { e.stopPropagation(); onCloneVariant(v.id); }}
                                                ...
                                                <button
                                                    onClick={(e) => { e.stopPropagation(); onDeleteVariant(v.id); }}
                                                    className="p-1.5 text-slate-300 hover:rose-500 transition-colors"
                                                >
                                                    <Trash2 size={14} />
                                                </button>
                                                <div className={`ml-1 p-1 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-400 transition-transform duration-500 ${isExpandedVariant ? 'rotate-90' : ''}`}>
                                            ...
                                            <div className="p-4 bg-slate-50/50 dark:bg-white/[0.01] border-t border-slate-100 dark:border-white/5 animate-in slide-in-from-top-4 duration-300">
                                                ...
                                                <div className="mb-6 p-6 bg-blue-500/[0.03] border border-blue-500/10 rounded-[2rem] space-y-4">
                                                    <div className="flex items-center gap-3 mb-2">
                                                        ...
                                                        <h4 className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-[0.2em] italic">Compliance & Taxation</h4>
                                                    </div>

                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div className="space-y-1.5">
                                                            <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block">HSN Code (6-Digit, e.g. 871120)</label>
                                                            <input
                                                                type="text"
                                                                placeholder="e.g. 871120"
                                                                value={v.hsnCode || ''}
                                                                onChange={(e) => onUpdateVariant(v.id, 'hsnCode', e.target.value)}
                                                        ...
                                                        <div className="space-y-1.5">
                                                            <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block">GST Rate (%)</label>
                                                            <div className="relative group">
                                                                <input
                                                                    type="number"
                                                                    placeholder="28"
                                                                    value={v.gstRate || ''}
                                                                    onChange={(e) => onUpdateVariant(v.id, 'gstRate', Number(e.target.value))}
                                                    ...
                                                    {v.gstRate ? (
                                                        <div className="flex gap-4 items-center p-3 bg-white dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5 border-dashed">
                                                            <div className="flex-1">
                                                                <p className="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-1">Tax Split</p>
                                                                <div className="flex gap-4">
                                                                    <div className="flex items-center gap-1.5">
                                                                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                                                                        <span className="text-[10px] font-bold text-slate-600 dark:text-slate-400">CGST: {v.gstRate / 2}%</span>
                                                                    </div>
                                                                    <div className="flex items-center gap-1.5">
                                                                        <div className="w-1.5 h-1.5 rounded-full bg-blue-400" />
                                                                        <span className="text-[10px] font-bold text-slate-600 dark:text-slate-400">SGST: {v.gstRate / 2}%</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="px-3 py-1 bg-blue-500/10 rounded-lg">
                                                                <span className="text-[9px] font-black text-blue-600">STATE REVENUE ELIGIBLE</span>
                                                            </div>
                                                        </div>
                                                    ) : (
                                                        <p className="text-[8px] font-medium text-slate-400 italic">Configure GST rate to see revenue breakdown.</p>
                                                    )}
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 gap-2">
                                                    {SPEC_CATEGORIES.map((cat) => {
                                                        const Icon = cat.icon;
                                                        const isSecExpanded = expandedSections.includes(`${v.id}-${cat.id}`);
                                                        return (
                                                            <div key={cat.id} className="relative pl-6">
                                                                ...
                                                                >
                                                                    <div className="flex items-center gap-3">
                                                                        <Icon size={16} className={`${isSecExpanded ? 'text-blue-500' : 'text-slate-400'}`} />
                                                                        <span className="text-[11px] font-black text-slate-600 dark:text-slate-300 uppercase tracking-widest italic">{cat.name}</span>
                                                                    </div>
                                                                    <ChevronRight size={14} className={`text-slate-300 transition-transform ${isSecExpanded ? 'rotate-90' : ''}`} />
                                                                </button>
                                                                    ...
                                                                    <div className="mt-3 ml-6 mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-300">
                                                                        {cat.fields.map(field => (
                                                                            <div key={field} className="space-y-1.5">
                                                                                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block">{field}</label>
                                                                                <input
                                                                                    type="text"
                                                                                    placeholder="Pending..."
                                                                                    value={v.specifications?.[cat.id]?.[field] || ''}
                                                                                    onChange={(e) => onUpdateVariant(v.id, 'specifications', {
                                                                                        ...v.specifications,
                                                                                        [cat.id]: {
                        ...
                        >
                            ...
                            <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest group-hover/add:text-blue-500">Append New Branch</span>
                        </button>
                    </div>
                )}
            </div>
            ...
            {variants.length === 0 && !isModelExpanded && (
                <div className="text-center py-20 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-[40px]">
                    <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">No active branches configured</p>
                </div>
            )}
        </div>
    );
