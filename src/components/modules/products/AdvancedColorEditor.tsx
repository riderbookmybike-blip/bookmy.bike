...
function SortableMediaItem({
    ...
    return (
        <div ref={setNodeRef} style={style} className="relative group/asset flex-shrink-0">
            <div
                onClick={onPreview}
...
export default function AdvancedColorEditor({
    ...
    const sharedModelVideo = colors.flatMap(c => c.media || []).find(m => m.type === 'video');
        ...
        <div className="w-full space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {selectedModel ? (
                <div className="relative">
                    ...
                    >
                        <div className="flex gap-4 items-center">
                            <div
                                className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 ${isModelExpanded ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'bg-slate-100 dark:bg-white/5 text-slate-400 group-hover:text-orange-500'}`}
                            >
                                <Palette size={20} />
                            </div>
                            <div>
                                <p className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] mb-0.5 italic">
                                    Visual Identity Root
                                </p>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="hidden md:flex flex-col items-end">
                                ...
                                <p className="text-[12px] font-black text-slate-600 dark:text-slate-300 italic">
                                    {colors.length} Variants Defined
                                </p>
                            </div>
                            <div
                    ...
                    {isModelExpanded && (
                        <div className="mt-4 space-y-4 pl-16 animate-in slide-in-from-top-4 duration-500">
                                                ...
                                                <div className="flex items-center gap-6 w-full">
                                                    ...
                                                    <div className="flex flex-col items-center gap-3 shrink-0">
                                                        <div className="flex items-center gap-2">
                                                            {(() => {
                                                                const firstImgIdx = colorMediaWithFallback.findIndex(
                                                                    m => m.type === 'image'
                                                                );
                                                                const firstVidIdx = colorMediaWithFallback.findIndex(
                                                                    m => m.type === 'video'
                                                                );
                                                                const firstImg =
                                                                    firstImgIdx !== -1
                                                                        ? colorMediaWithFallback[firstImgIdx]
                                                                        : null;
                                                                const firstVid =
                                                                    firstVidIdx !== -1
                                                                        ? colorMediaWithFallback[firstVidIdx]
                                                                        : null;
                                                                            ...
                                                                            <div
                                                                                onClick={() =>
                                                                                    setPreviewMedia({
                                                                                        color: {
                                                                                            ...color,
                                                                                            media: colorMediaWithFallback,
                                                                                        },
                                                                                        initialIdx: firstImgIdx,
                                                                                    })
                                                                                }
                                                        ...
                                                        <button
                                                            onClick={() =>
                                                                colorMediaWithFallback.length > 0 &&
                                                                setPreviewMedia({
                                                                    color: { ...color, media: colorMediaWithFallback },
                                                                    initialIdx: 0,
                                                                })
                                                            }
                                                        ...
                                                        {color.variantIds && color.variantIds.length > 0 && (
                                                            <div className="flex flex-wrap gap-1 mt-1">
                                                                {color.variantIds.map(vid => {
                                                                    const vName =
                                                                        modelVariants.find(v => v.id === vid)?.name ||
                                                                        'Unknown';
                                                                    return (
                                                                        <span
                                                                            key={vid}
                                                                            className="px-1.5 py-0.5 bg-blue-500/10 text-[7px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest rounded border border-blue-500/20"
                                                                        >
                                                                            {vName}
                                                                        </span>
                                                                    );
                                                            ...
                                                            <div className="flex items-center gap-1.5 p-1 bg-slate-100 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/10 group/picker">
                                                                <div
                                                                    ...
                                                                    style={{
                                                                        background: color.code.includes(',')
                                                                            ? `linear-gradient(135deg, ${color.code.split(',')[0]} 50%, ${color.code.split(',')[1]} 50%)`
                                                                            : color.code,
                                                                    }}
                                                                >
                                                                ...
                                                                <div className="flex flex-col gap-1.5 ml-1">
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <button
                                                                            onClick={() =>
                                                                                handlePickColor(color.id, 'primary')
                                                                            }
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        <input
                                                                            type="text"
                                                                            value={
                                                                                color.code.split(',')[1]?.trim() || ''
                                                                            }
                                                                            placeholder="DUAL TONE"
                                                                            onChange={e => {
                                                                                const pri = color.code
                                                                                    .split(',')[0]
                                                                                    .trim();
                                                                        ...
                                                                        <button
                                                                            onClick={() =>
                                                                                handlePickColor(color.id, 'secondary')
                                                                            }
                                                        ...
                                                        <div className="space-y-4">
                                                            <div className="flex items-center justify-between">
                                                                <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic">
                                                                    Media Library ({color.media.length})
                                                                </h5>
                                                            ...
                                                            <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide">
                                                                {color.media.length === 0 && (
                                                                    <div className="w-full h-16 border-2 border-dashed border-slate-100 dark:border-white/5 rounded-2xl flex flex-col items-center justify-center gap-1 opacity-50">
                                                                        ...
                                                                        <p className="text-[7px] font-bold uppercase text-slate-400 tracking-widest">
                                                                            No assets uploaded
                                                                        </p>
                                                                    </div>
                                                                )}
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        {colorMediaWithFallback.map((item, idx) => (
                                                                            <div
                                                                                key={item.id}
                                                                                className="relative group/asset-container"
                                                                            >
                                                                                <SortableMediaItem
                                                                                    item={item}
                                                                                    idx={idx}
                                                                        ...
                                                                        <div key={v.id} className="flex flex-col gap-3">
                                                                            <div className="flex items-center justify-between group/var-row">
                                                                                <button
                                                                                    ...
                                                                                    className={`px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-tight border transition-all duration-300 flex items-center gap-2 ${
                                                                                        isSelected
                                                                                ...
                                                                                {isSelected && (
                                                                                    <div className="flex items-center gap-1.5 p-1 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/10 shadow-sm transition-all">
                                                                                        <button
                                                                                            ...
                                                                                            title={
                                                                                                isPrimary
                                                                                                    ? 'Primary - This photo will represent this color in the Catalog'
                                                                                                    : 'Designate as Primary Photo'
                                                                                            }
                                                                                        >
                                                                                            <Star
                                                                                                size={10}
                                                                                ...
                                                                                <div className="flex flex-col gap-2 ml-4 border-l-2 border-blue-500/20 pl-4">
                                                                                    ...
                                                                                    <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                                                                                        {variantMedia.map(item => (
                                                                                            <div
                                                                                                key={item.id}
                                                                                                className="relative group/var-asset flex-shrink-0"
                                                                                            >
                                                                                                <div
                                                                                                    onClick={() =>
                                                                                                        setPreviewMedia(
                            ...
                            >
                                ...
                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] group-hover/add:text-orange-500 italic">
                                    Initiate New Core Finish Branch
                                </span>
                            </button>
                        </div>
                    )}
                ...
                <div className="flex flex-col items-center justify-center h-[500px] bg-white dark:bg-white/[0.01] border-2 border-dashed border-slate-200 dark:border-white/5 rounded-[56px] animate-in fade-in duration-700">
                    ...
                    <p className="text-slate-400 font-black uppercase tracking-[0.3em] text-[10px] mb-2 italic">
                        Color Configuration Matrix
                    </p>
                    <h4 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic">
                        Context Required
                    </h4>
                    <p className="text-sm text-slate-400 font-bold uppercase tracking-widest mt-4">
                        Select a model from the left branch to begin visual mapping
                    </p>
                </div>
            )}
                        ...
                        <div className="fixed inset-0 z-[999] bg-white/95 dark:bg-slate-950/95 flex flex-col items-center justify-center backdrop-blur-xl animate-in fade-in duration-500">
                            ...
                            <div className="w-full max-w-6xl px-10 flex flex-col items-center">
                                <div className="text-center mb-10">
                                    <h2 className="text-6xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic">
                                        {previewMedia.color.name}
                                    </h2>
                                    <p className="text-blue-500 font-black uppercase tracking-[0.5em] mt-4 italic">
                                        Live Visual Discovery
                                    </p>
                                </div>
