...
export const MarketplaceHeader = ({ onLoginClick }: MarketplaceHeaderProps) => {
    ...
    return (
        ...
        >
            ...
            {isMobileMenuOpen && (
                <div
                    className="md:hidden bg-white dark:bg-[#0f1115] border-t border-slate-200 dark:border-white/5 p-6 space-y-8 animate-in slide-in-from-top-4 duration-300 shadow-2xl h-screen fixed inset-0 z-40 overflow-y-auto"
