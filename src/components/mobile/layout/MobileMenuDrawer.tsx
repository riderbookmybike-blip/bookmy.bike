                        ...
                        <div className="p-5 border-b border-zinc-800">
                            ...
                            <div className="flex items-center gap-3 p-4 bg-zinc-900 rounded-2xl">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-black text-white mb-1">Guest User</p>
                        ...
                        <div className="flex-1 overflow-y-auto p-5 space-y-2">
                            {MENU_ITEMS.map((item, idx) => (
                                <motion.button
                                    ...
                                    className="w-full flex items-center gap-4 p-4 bg-zinc-900 hover:bg-zinc-800 rounded-xl transition-all active:scale-95 group"
                                >
