...
export const MembershipCard: React.FC<MembershipCardProps> = ({
    ...
    const w = wallet || {};
    const availableBalance = (w.available_system || 0) + (w.available_referral || 0) + (w.available_sponsored || 0);
    const lockedBalance = w.locked || 0;
    const referralEarned = w.available_referral || 0;
    const consumed = w.lifetime_redeemed || 0;
    ...
    return (
        ...
        >
            <div
                ...
                className={`relative w-full ${compact ? 'max-w-[620px]' : 'max-w-[540px]'} aspect-[1.586/1] cursor-pointer`}
            ...
            >
                ...
                >
                            ...
                            <div className="space-y-4 border-t border-white/5 pt-6">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-sm font-mono tracking-widest text-[#F4B000]">
                                            {validity}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-end">
                                    <div className="text-sm md:text-lg font-bold tracking-[0.05em] text-white/90 uppercase italic whitespace-nowrap truncate">
                                        {name}
                                    </div>
                    ...
                    >
                        ...
                        {/* Magnetic stripe */}
                        <div className="absolute top-[12%] left-0 right-0 h-[12%] bg-gradient-to-r from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a]" />
                        ...
                        <div className="relative h-full w-full p-6 md:p-10 flex flex-col justify-between">
                            ...
                            <div className="flex justify-between items-center mt-[16%]">
                                <div className="flex items-center gap-1.5">
                                    <div className="w-1 h-1 rounded-full bg-[#F4B000]" />
                                    <span className="text-[7px] md:text-[9px] font-black uppercase tracking-[0.25em] text-[#F4B000]">
                                        B-Coin Ledger
                                    </span>
                                </div>
                                <span className="text-[7px] font-black uppercase tracking-[0.15em] text-white/20">
                                    Tap to flip back
                                </span>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-x-6 gap-y-4 mt-4">
                                {/* Available */}
                                <div>
                                    <div className="text-[7px] md:text-[8px] font-black uppercase tracking-[0.2em] text-white/30 mb-1">
                                        Available
                                    </div>
                                    <div className="text-xl md:text-2xl font-black text-[#F4B000] italic tracking-tight">
                                ...
                                <div>
                                    ...
                                    <div className="text-xl md:text-2xl font-black text-white/60 italic tracking-tight">
                                ...
                                <div>
                                    ...
                                    <div className="text-xl md:text-2xl font-black text-emerald-400 italic tracking-tight">
                                        {referralEarned.toLocaleString('en-IN')}
                                    </div>
                                    <div className="text-[6px] md:text-[7px] text-white/20 uppercase tracking-wider mt-0.5">
                                        Pending delivery unlock
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-xl md:text-2xl font-black text-rose-400 italic tracking-tight">
                            ...
                            <div className="flex justify-between items-end border-t border-white/5 pt-3">
                                <div className="font-mono text-[10px] md:text-xs tracking-wider text-white/30">
                                    {id}
                                </div>
                                <div className="text-[7px] md:text-[8px] font-black uppercase tracking-tighter text-white/10 italic">
                                    Official <span className="text-[#F4B000]/20">Privilege</span>
                                </div>
                            </div>
                        </div>
                    </div>
