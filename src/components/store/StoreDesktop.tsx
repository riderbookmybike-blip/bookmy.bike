    ...
    return (
        <div className="flex flex-col pb-40 transition-colors duration-300">
            ...
            >
                ...
                <div
                    className={`mx-auto relative z-10 w-full text-center ${isTv ? 'max-w-[1800px] px-24 xl:px-44 pt-6 pb-4' : 'max-w-[1440px] 2xl:max-w-[1680px] px-6 md:px-12 lg:px-20 pt-12 pb-8'}`}
                >
