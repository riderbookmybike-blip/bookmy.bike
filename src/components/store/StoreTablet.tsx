                ...
                <div className="max-w-4xl mx-auto relative z-10 w-full text-center pt-20">
                    <div className="space-y-10">
                        ...
                        <p className="max-w-2xl mx-auto text-lg text-slate-500 font-medium tracking-wide italic leading-relaxed">
                            ...
                            Unified rates from verified dealers. Instant location-based quotes.
                        </p>

                        <div className="flex flex-col items-stretch max-w-lg mx-auto gap-4 mt-8">
                            <Link href="/store/catalog" className="h-16 bg-slate-900 text-white rounded-2xl flex items-center justify-center gap-3 px-8 font-black uppercase tracking-widest text-[10px] shadow-xl">
            ...
            <section className="py-32 bg-white dark:bg-[#020617] px-12">
                ...
                <div className="grid grid-cols-2 gap-4">
                    {['HONDA', 'TVS', 'ROYAL ENFIELD', 'BAJAJ', 'SUZUKI', 'YAMAHA'].map((brand) => (
                        ...
                        >
                            <span className="font-black uppercase tracking-[0.2em] text-slate-400 dark:text-slate-600 text-xs">{brand}</span>
                        </Link>
                    ))}
                </div>
            </section>
                ...
                <div className="grid grid-cols-2 gap-6">
                    {[
                        ...
                        <Link key={i} href="/store/catalog" className="relative h-96 overflow-hidden rounded-[3rem] border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/50 flex flex-col justify-end p-8">
                            ...
                            <img src={cat.img} alt={cat.title} className="absolute top-1/4 left-1/4 w-[80%] opacity-80" />
                        </Link>
                    ))}
                </div>
            </section>
