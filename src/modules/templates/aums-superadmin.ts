    ...
    groups: [
        {
            ...
            title: 'Dashboard',
            order: 1,
            items: [{ id: 'dashboard-main', title: 'Platform Overview' }],
        },
        {
            id: 'operations',
            title: 'Operations',
        ...
        },
        {
            ...
            order: 3,
            items: [{ id: 'inventory-requisitions' }, { id: 'inventory-orders' }, { id: 'inventory-stock' }],
        },
        {
            id: 'crm',
            title: 'Sales & CRM',
            order: 4,
            items: [
                { id: 'members-main', href: '/app/aums/members' },
