...
export const WIDGET_REGISTRY: Record<string, RegisteredWidget> = {
    'kpi-card': {
        component: KpiCard,
        defaultProps: { title: 'Metric', value: '0', sub: 'Subtitle', trend: 'neutral', icon: 'Activity' },
...
export const getWidgetComponent = (type: string) => {
    return (
        ...
        (() => (
            <div className="p-4 bg-red-50 text-red-500 font-bold border border-red-200 rounded-lg">
