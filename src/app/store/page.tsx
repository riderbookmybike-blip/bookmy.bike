                    ...
                    <div className="flex flex-col gap-12 md:gap-20">
                        <div className="relative group overflow-hidden">
                            <div className="flex animate-marquee gap-8 whitespace-nowrap py-10 w-max pr-8">
                                {[
                                    { name: 'Arjun', bike: 'Pulsar NS200', quote: 'Showroom me 2 mahine ki waiting thi, yahan 5 din me mil gayi. Transparent breakdown best hai.' },
                                    { name: 'Priya', bike: 'Honda Activa 6G', quote: 'Online buying me darr tha par Lowest EMI guarantee ne 4k bachaye. Delivery team 10/10.' },
                                    { name: 'Rahul', bike: 'Apache RTR 160', quote: 'EMI approve ho gayi 10 minutes me. No hidden charges. Total peace of mind.' },
                                    { name: 'Sneha', bike: 'TVS Jupiter 125', quote: 'BMB handled everything—subsidies, taxes, registration. Booking made easy.' },
                                    { name: 'Karthik', bike: 'Yamaha FZ-S V4', quote: 'Got the Racing Blue variant when it was out of stock everywhere. Massive network.' },
                                    { name: 'Amit', bike: 'Hero Splendor Plus', quote: 'Daily commute ke liye bike chahiye thi fast. Zero hidden costs. Delivered to office.' },
                                    { name: 'Vikram', bike: 'Suzuki Access 125', quote: 'Concierge team is very professional. Professional help with documentation.' },
                                    { name: 'Anjali', bike: 'TVS Raider 125', quote: 'Everything from insurance to registration was handled in the app. Smooth digital process.' },
                                    { name: 'Siddharth', bike: 'Bajaj Dominar 250', quote: 'Elite Circle privileges are real. Priority delivery and premium kit was a surprise.' },
                                    { name: 'Neha', bike: 'Suzuki Burgman', quote: 'Found the specific color no local dealer had. Delivered in pristine condition.' },
                                    { name: 'Manish', bike: 'Hero Xpulse 200T', quote: 'EMI calculator is spot on. No processing fee surprises. Paid what was shown.' },
                                    { name: 'Rohan', bike: 'Honda Hornet 2.0', quote: 'Unified pricing across dealers stopped the showroom haggling immediately.' },
                                    { name: 'Deepak', bike: 'TVS Ronin', quote: 'On-road price was lower than local dealers. Verified by evening.' },
                                    { name: 'Suresh', bike: 'Yamaha RayZR 125', quote: 'Smooth experience. Best for busy professionals who dont want to waste weekends.' },
                                    { name: 'Megha', bike: 'Yamaha MT-15 V2', quote: 'Loved the UI. Seeing every variant in high-res helped me decide. 100% happy.' },
                                ].concat([
                                    { name: 'Arjun', bike: 'Pulsar NS200', quote: 'Showroom me 2 mahine ki waiting thi, yahan 5 din me mil gayi. Transparent breakdown best hai.' },
                                    { name: 'Priya', bike: 'Honda Activa 6G', quote: 'Online buying me darr tha par Lowest EMI guarantee ne 4k bachaye. Delivery team 10/10.' },
                                    { name: 'Rahul', bike: 'Apache RTR 160', quote: 'EMI approve ho gayi 10 minutes me. No hidden charges. Total peace of mind.' },
                        ...
                        <div className="relative overflow-hidden">
                            <div className="flex animate-marquee-reverse gap-8 whitespace-nowrap py-10 w-max pr-8">
                                {[
                                    { name: 'Abhishek', bike: 'Hero XPulse 200', quote: 'The delivery was surprising but they managed it. Trustworthy service.' },
                                    { name: 'Divya', bike: 'Suzuki Burgman', quote: 'White glove delivery is legit. They even helped me with temporary reg plate.' },
                                    { name: 'Ishaan', bike: 'Bajaj Pulsar 150', quote: 'Fastest finance approval. Document upload to approval took less than 15 mins.' },
                                    { name: 'Rajesh', bike: 'Honda Shine 125', quote: 'Verified status of dealers gives confidence. Professional and quick.' },
                                    { name: 'Pooja', bike: 'TVS Jupiter', quote: 'Simple, fast, and secure. Made the perfect gift for my brother birthday.' },
                                    { name: 'Nitin', bike: 'Suzuki Gixxer SF', quote: 'The delivery was on time. Bike came in a closed truck, no scratches.' },
                                    { name: 'Shubham', bike: 'Yamaha FZ', quote: 'Comparing EMIs of 4 banks in one screen saved me at least 1% interest rate.' },
                                    { name: 'Anita', bike: 'Honda Dio', quote: 'The member dashboard shows my booking status live. Very helpful.' },
                                    { name: 'Varun', bike: 'Bajaj Pulsar N250', quote: 'Early access for members helped me get into the first batch. Worth it.' },
                                    { name: 'Alok', bike: 'Hero Glamour', quote: 'Simple Hinglish support made the process very easy for my father.' },
                                    { name: 'Tanvi', bike: 'TVS NTORQ 125', quote: 'Eco-friendly process. No paperwork, just digital signatures. The way forward.' },
                                    { name: 'Jatin', bike: 'Hero Passion Pro', quote: 'Great price, great service. Highly recommended.' },
                                    { name: 'Kavita', bike: 'TVS XL100', quote: 'Bought for my business delivery. Helped me get bulk registration handled.' },
                                    { name: 'Sameer', bike: 'Suzuki Gixxer 150', quote: 'Got delivery even in tough weather conditions. The team is dedicated to the rider.' },
                                    { name: 'Ritu', bike: 'Honda Shine', quote: 'The delivery timeline was very clear. Bike arrived today!' },
                                ].concat([
                                    { name: 'Abhishek', bike: 'Hero XPulse 200', quote: 'The delivery was surprising but they managed it. Trustworthy service.' },
                                    { name: 'Divya', bike: 'Suzuki Burgman', quote: 'White glove delivery is legit. They even helped me with temporary reg plate.' },
                                    { name: 'Ishaan', bike: 'Bajaj Pulsar 150', quote: 'Fastest finance approval. Document upload to approval took less than 15 mins.' },
