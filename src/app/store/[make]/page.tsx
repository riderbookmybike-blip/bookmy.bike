            ...
            <main>
                ...
                <section className="relative min-h-[60vh] flex flex-col pt-28 pb-16 overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        ...
                        <div className="absolute inset-0 bg-slate-100 transition-colors" />
                    ...
                    <div className="page-container relative z-20">
                        <div className="max-w-3xl space-y-8">
                            ...
                            <div className="space-y-4">
                                <p className="text-[12px] font-black text-slate-500 uppercase tracking-[0.5em] italic">
                                    Premier Selection
                                </p>
                                <h1 className="text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter italic leading-[0.8] text-slate-900">
                                    {brandName}
                                </h1>
                                <p className="text-xl md:text-2xl font-bold text-slate-600 tracking-tight italic">
                                    {brandTagline}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 pt-8">
                                <Link
                                    ...
                                    className="w-full sm:w-auto px-10 py-5 bg-slate-900 text-white rounded-2xl text-sm font-black uppercase tracking-widest transition-all shadow-2xl flex items-center justify-center gap-3 active:scale-95"
                                >
                                    Browse Lineup <ArrowRight size={18} />
                                </Link>
                                <button className="w-full sm:w-auto px-10 py-5 bg-white/50 border border-slate-200 rounded-2xl text-sm font-black uppercase tracking-widest text-slate-900 transition-all backdrop-blur-md">
                                    Brand Story
                                </button>
                            </div>
                        </div>
                ...
                <section className="py-24 bg-slate-50 border-y border-slate-200 transition-colors">
                ...
                <section className="py-24 md:py-32 bg-white transition-colors">
                    <div className="page-container">
                        <div className="text-center mb-20 space-y-4">
                            <p className="text-[12px] font-black text-blue-600 uppercase tracking-[0.5em] italic">
                                The Lineup
                            </p>
                            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic text-slate-900 transition-colors">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-6">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="group relative h-[550px] overflow-hidden rounded-[3rem] border border-slate-200 bg-white flex flex-col items-center justify-end p-6 md:p-10 shadow-2xl shadow-slate-200/50 transition-all"
                                >
                                    <div className="absolute inset-0 bg-gradient-to-t from-slate-100 via-slate-100/20 to-transparent z-10 transition-colors" />
                                    <div className="absolute inset-0 bg-slate-50 scale-100 group-hover:scale-110 transition-transform duration-1000 opacity-50" />
                                    ...
                                    <div className="relative z-20 space-y-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-700 w-full text-center">
                                        <div className="space-y-4">
                                            ...
                                            <h3 className="text-3xl font-black uppercase tracking-tighter italic text-slate-900 transition-colors">
                                                {cat.title}
                                            </h3>
                                            <div className="space-y-2 opacity-80 group-hover:opacity-100 transition-opacity">
                                                <p className="text-sm text-slate-700 font-bold uppercase tracking-widest transition-colors">
                                                    {cat.subtitle}
                                                </p>
                                                <p className="text-xs text-slate-500 font-medium leading-relaxed transition-colors">
                                                    {cat.desc}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <Link
                                            href={cat.link}
                                            className="w-full py-4 bg-slate-900 text-white hover:bg-blue-600 hover:text-white rounded-xl text-[11px] font-black uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 shadow-xl"
                                        >
                                            View Collection
                                        </Link>
                                    </div>
