                ...
                <section className="relative min-h-[60vh] flex flex-col pt-32 pb-16 overflow-hidden">
                    ...
                    <div className="max-w-[1400px] mx-auto px-6 relative z-20 w-full">
                        <div className="max-w-3xl space-y-8">
                            <Link href="/store" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-blue-600 dark:text-blue-500 hover:gap-4 transition-all">
                                <ArrowLeft size={14} /> Back to Store
                            </Link>

                            <div className="space-y-4">
                                <p className="text-[12px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.5em] italic">Premier Selection</p>
                    ...
                    <div className="max-w-[1400px] mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            <div className="space-y-4">
                                ...
                                <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900 dark:text-white">Built To Last</h3>
                            ...
                            <div className="space-y-4">
                                ...
                                <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900 dark:text-white">Smart Tech</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                            ...
                            <div className="space-y-4">
                                ...
                                <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900 dark:text-white">High Resale</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                ...
                <section className="py-24 md:py-40 bg-white dark:bg-black transition-colors">
                    <div className="max-w-[1400px] mx-auto px-6">
                        <div className="text-center mb-20 space-y-4">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white transition-colors">Featured {brandName} Models</h2>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-6">
                            {[
                                { title: 'Scooters', subtitle: 'Urban Mobility.', desc: 'Daily commute perfected.', img: '/images/categories/scooter_nobg.png', color: 'bg-cyan-500', link: `/store/catalog?category=SCOOTER&brand=${brandName.toUpperCase()}` },
                                { title: 'Motorcycles', subtitle: 'Power & Performance.', desc: 'Engineered for the open road.', img: '/images/categories/motorcycle_nobg.png', color: 'bg-rose-500', link: `/store/catalog?category=MOTORCYCLE&brand=${brandName.toUpperCase()}` },
                    ...
                    <div className="max-w-5xl mx-auto px-6 text-center space-y-12 relative z-10">
                        <div className="space-y-6">
                            ...
                            <p className="text-slate-400 max-w-2xl mx-auto text-lg font-medium">
                                Get instant quotes, customized finance plans, and doorstep delivery for all {brandName} models.
                            </p>
                        </div>
                        <Link
                            href={`/store/catalog?brand=${brandName.toUpperCase()}`}
