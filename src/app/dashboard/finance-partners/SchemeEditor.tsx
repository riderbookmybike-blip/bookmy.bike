                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    className="w-full bg-emerald-500/[0.03] dark:bg-emerald-500/5 border border-emerald-500/20 dark:border-emerald-500/10 rounded-[14px] px-4 py-3 text-emerald-600 dark:text-emerald-400 font-bold focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all"
                                />
                                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-emerald-500/40 uppercase tracking-widest">Waved</span>
                            </div>
                        </div>

                        <div>
                            <label className="text-[10px] uppercase font-black text-red-500 tracking-widest mb-2 block flex items-center gap-2">
                                <Minus size={10} /> Subvention
                            </label>
                            <div className="flex gap-2">
                                <input
                                    type="number"
                                    ...
                                    className="flex-1 bg-red-500/[0.03] dark:bg-red-500/5 border border-red-500/20 dark:border-red-500/10 rounded-[14px] px-4 py-3 text-red-600 dark:text-red-400 font-bold focus:border-red-500/50 focus:ring-4 focus:ring-red-500/10 outline-none transition-all"
                                />
                                <select
