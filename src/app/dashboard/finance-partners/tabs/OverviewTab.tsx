...
import { Building2, Activity, Globe, Mail, Phone, ShieldCheck, CheckCircle2, Clock, BarChart4, MapPin, Zap, Camera, Smartphone, MessagesSquare, Headphones, ExternalLink, Loader2 } from 'lucide-react';
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-200 dark:border-white/5">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-tight">Website</div>
                                                <div className="text-xs text-blue-600 dark:text-blue-400 font-bold truncate max-w-[120px]">{partner.overview.website || 'N/A'}</div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-tight">WhatsApp</div>
                                                <div className="text-xs text-slate-700 dark:text-white font-bold">{partner.overview.whatsapp || 'N/A'}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-tight">Customer Care</div>
                                                <div className="text-xs text-slate-700 dark:text-white font-bold">{partner.overview.customerCare || partner.overview.supportPhone || 'N/A'}</div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-tight">Helpline</div>
                                                <div className="text-xs text-slate-700 dark:text-white font-bold">{partner.overview.helpline || '1800-XXX-XXXX'}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-slate-50 dark:bg-black/40 rounded-3xl border border-slate-200 dark:border-white/5 p-6 space-y-6">
                                <div className="flex items-center justify-between">
                                    <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Brand Identity</h4>
                                    <span className="text-[8px] font-black bg-blue-500 text-white px-2 py-0.5 rounded-full uppercase">Updateable</span>
                                </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="aspect-video bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-white/10 flex items-center justify-center relative overflow-hidden group">
                                            {partner.identity?.fullLogo ? (
                                                <img src={partner.identity.fullLogo} alt="Full Logo" className="max-h-[70%] max-w-[80%] object-contain" />
                                            ) : (
                                        ...
                                        <p className="text-[9px] font-black text-center text-slate-500 uppercase tracking-tighter italic">Corporate Logo (Wide)</p>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="aspect-square bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-white/10 flex items-center justify-center relative overflow-hidden group">
                                            {partner.identity?.iconLogo ? (
                                                <img src={partner.identity.iconLogo} alt="Icon Logo" className="w-12 h-12 object-contain" />
                                            ) : (
                                        ...
                                        <p className="text-[9px] font-black text-center text-slate-500 uppercase tracking-tighter italic">App Icon (Square)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-[32px] p-10 shadow-sm dark:shadow-2xl">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    <div key={i} className="bg-slate-50 dark:bg-black/40 p-5 rounded-[24px] border border-slate-200 dark:border-white/5 shadow-inner hover:bg-slate-100 dark:hover:bg-black/20 transition-colors group">
                                        ...
                                        <div className="text-xl font-black text-slate-900 dark:text-white italic tracking-tighter">{p.value}</div>
                            ...
                            <div className="space-y-4">
                                <div className="p-5 bg-slate-50 dark:bg-black/40 rounded-[24px] border border-slate-200 dark:border-white/5 hover:border-blue-500/30 transition-all cursor-pointer group">
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Android App</div>
                                ...
                                <div className="p-5 bg-slate-50 dark:bg-black/40 rounded-[24px] border border-slate-200 dark:border-white/5 hover:border-blue-500/30 transition-all cursor-pointer group">
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">iOS App</div>
                                        <ExternalLink size={12} className="text-slate-400 group-hover:text-blue-500" />
                                    </div>
                                    <div className="text-xs font-bold text-slate-600 dark:text-slate-300 truncate group-hover:text-blue-400 transition-colors italic">
