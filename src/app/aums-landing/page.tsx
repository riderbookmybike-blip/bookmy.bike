                    ...
                    <div className="flex flex-col items-center text-center space-y-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 pt-8">
                            <button
                                ...
                                className="w-full sm:w-auto px-10 py-5 bg-white text-black hover:bg-slate-200 rounded-xl text-sm font-black uppercase tracking-widest transition-all flex items-center justify-center gap-3"
                            >
