    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6 font-sans">
            ...
            <div className="w-full max-w-2xl mb-12 flex items-center justify-between">
                <Logo className="h-8" />
                <div className="text-xs font-black uppercase tracking-widest text-slate-400">Setup Wizard</div>
            </div>
            ...
            <div className="w-full max-w-2xl mb-12 relative">
                ...
                <div
                    ...
                    style={{
                        width: step === 'INFO' ? '15%' : step === 'BRAND' ? '50%' : step === 'TEAM' ? '80%' : '100%',
                    }}
                />
                    ...
                    {['INFO', 'BRAND', 'TEAM'].map((s, i) => {
                        ...
                        return (
                            <div key={s} className="flex flex-col items-center gap-3">
                                <div
                                    className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${isActive ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30 scale-110' : isPast ? 'bg-emerald-500 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-400'}`}
                                >
                                    {isPast ? (
                                ...
                                <span
                                    className={`text-[10px] font-black uppercase tracking-wider ${isActive ? 'text-indigo-600' : 'text-slate-400'}`}
                                >
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-6 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-dashed border-slate-300 dark:border-white/20 flex flex-col items-center justify-center text-center gap-3">
                                ...
                                <button className="text-[10px] bg-white dark:bg-white/10 border border-slate-200 dark:border-white/10 px-4 py-2 rounded-lg font-bold hover:bg-slate-50 transition-colors">
                                    Select File
                                </button>
                            </div>
                        </div>
                        ...
                        >
                            {saving ? (
                                ...
                                <>
                                    Design Looks Good <ArrowRight size={16} />
                                </>
                            )}
                        </button>
                    </div>
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-xl flex gap-3 border border-blue-100 dark:border-blue-500/20">
                            ...
                            <p className="text-xs text-blue-600 dark:text-blue-400 leading-relaxed font-medium">
                                You are the <b>Owner</b>. You can add more admins, sales executives, or operations staff
                                later from Settings.
                            </p>
                        </div>
