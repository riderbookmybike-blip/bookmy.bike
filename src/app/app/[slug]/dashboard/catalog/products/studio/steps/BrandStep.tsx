                    ...
                    {brands.map((brand: any) => {
                        ...
                        return (
                            <div
                                ...
                                className={`group relative p-6 rounded-[2rem] border-2 transition-all duration-500 text-left overflow-hidden cursor-pointer ${
                                ...
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <div className="flex items-center justify-center gap-8 mt-4 pt-5 border-t border-slate-100 dark:border-white/5 w-full">
                                        <div className="flex items-center gap-2 text-purple-500" title="Models">
                                            ...
                                            <span className="text-xs font-black">{brandStats.families}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-indigo-500" title="Variants">
                                            <Layers size={18} strokeWidth={2.5} />{' '}
                                            <span className="text-xs font-black">{brandStats.variants}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-emerald-500" title="SKUs">
                                            <Grid3X3 size={18} strokeWidth={2.5} />{' '}
                                            <span className="text-xs font-black">{brandStats.skus}</span>
                                        </div>
                                    </div>
                                </div>
                                {selectedBrand === brand.id && (
