...
export default async function AumsTemplateStudioPage() {
    ...
    return (
        <div className="p-8 max-w-[1600px] mx-auto space-y-8">
            <div>
                ...
                <p className="text-slate-500 dark:text-slate-400">Manage and assign layout templates for Dashboards.</p>
            </div>

            <UnifiedTemplateStudio dashboardTemplates={dashboardTemplates} dashboardAssignments={assignments} />
        </div>
    );
}
