...
export async function POST(request: NextRequest) {
    try {
        ...
        const TEMPLATE_ID = '6966079a8e1222c164607d3'; // Valid Template ID required for v5 API
        ...
        if (action === 'send') {
            ...
            const url = `https://control.msg91.com/api/v5/otp?authkey=${AUTH_KEY}&template_id=${TEMPLATE_ID}&mobile=${formattedPhone}&otp_length=4&expiry=${OTP_EXPIRY}`;
