  ...
  public: {
    ...
    Functions: {
      ...
      get_market_best_offers: {
        Args: { p_district?: string; p_state_code: string }
        Returns: {
          best_offer: number
          bundle_price: number
          bundle_value: number
      ...
      reconcile_all_members: { Args: never; Returns: undefined }
