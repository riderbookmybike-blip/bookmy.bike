...
-- Seed Data (from Mock Store) - guarded for both schemas
DO $$
BEGIN
    IF EXISTS (
        SELECT 1
        ...
        ('871120', 'Motorcycles with reciprocating internal combustion piston engine of a cylinder capacity exceeding 50cc but not exceeding 250cc', 28, 'VEHICLE', '2017-07-01'),
        ('871130', 'Motorcycles exceeding 250cc but not exceeding 500cc', 28, 'VEHICLE', '2017-07-01'),
        ('650610', 'Safety Headgear (Helmets)', 18, 'ACCESSORY', '2017-07-01'),
        ('871410', 'Parts and accessories of motorcycles (including mopeds)', 18, 'PART', '2017-07-01'),
        ('998729', 'Maintenance and repair services of motorcycles', 18, 'SERVICE', '2017-07-01')
