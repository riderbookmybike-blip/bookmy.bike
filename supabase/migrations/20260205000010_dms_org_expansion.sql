...
-- LOCATIONS
DROP POLICY IF EXISTS "Super Admin Manage Locations" ON public.id_locations;
DROP POLICY IF EXISTS "Owner Manage Locations" ON public.id_locations;
DROP POLICY IF EXISTS "Team Read Locations" ON public.id_locations;
...
-- DOCUMENTS
DROP POLICY IF EXISTS "Super Admin Manage Documents" ON public.id_documents;
DROP POLICY IF EXISTS "Owner Manage Documents" ON public.id_documents;
...
-- BANK ACCOUNTS
DROP POLICY IF EXISTS "Super Admin Manage Bank" ON public.id_bank_accounts;
DROP POLICY IF EXISTS "Owner Manage Bank" ON public.id_bank_accounts;
...
-- OPERATING HOURS
DROP POLICY IF EXISTS "Super Admin Manage Hours" ON public.id_operating_hours;
DROP POLICY IF EXISTS "Owner Manage Hours" ON public.id_operating_hours;
DROP POLICY IF EXISTS "Public Read Hours" ON public.id_operating_hours;
