...
REVOKE ALL ON FUNCTION public.publish_price_with_lock(UUID, TEXT, NUMERIC, NUMERIC, UUID, UUID) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.publish_price_with_lock(UUID, TEXT, NUMERIC, NUMERIC, UUID, UUID) TO service_role;

COMMENT ON FUNCTION public.publish_price_with_lock(UUID, TEXT, NUMERIC, NUMERIC, UUID, UUID) IS 
