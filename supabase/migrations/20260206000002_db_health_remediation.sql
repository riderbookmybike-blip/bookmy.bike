...
CREATE TABLE IF NOT EXISTS public.crm_finance (
...
CREATE TABLE IF NOT EXISTS public.mat_market_summary (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);
...
CREATE TABLE IF NOT EXISTS public.cat_price_state_trash (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);

CREATE TABLE IF NOT EXISTS public.cat_price_dealer (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  brand_id UUID,
  vehicle_model_id UUID
);

CREATE TABLE IF NOT EXISTS public.crm_booking_assets (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID,
  uploaded_by UUID
);

CREATE TABLE IF NOT EXISTS public.crm_insurance (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID
);
...
CREATE TABLE IF NOT EXISTS public.crm_pdi (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);

CREATE TABLE IF NOT EXISTS public.crm_registration (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);

CREATE TABLE IF NOT EXISTS public.id_member_assets (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);
...
CREATE TABLE IF NOT EXISTS public.sys_archived (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);

CREATE TABLE IF NOT EXISTS public.sys_role_templates (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);
