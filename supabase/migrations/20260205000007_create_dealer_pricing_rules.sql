...
CREATE UNIQUE INDEX IF NOT EXISTS uq_id_dealer_pricing_rules_tenant_vehicle_state
  ON public.id_dealer_pricing_rules(tenant_id, vehicle_color_id, state_code);
