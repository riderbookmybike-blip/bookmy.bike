...
CREATE TABLE IF NOT EXISTS public.cat_items (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);

CREATE TABLE IF NOT EXISTS public.cat_brands (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid()
);
...
ALTER TABLE public.cat_item_compatibility
    DROP CONSTRAINT IF EXISTS cat_item_compatibility_universal_chk;
ALTER TABLE public.cat_item_compatibility
    ADD CONSTRAINT cat_item_compatibility_universal_chk
    CHECK (
