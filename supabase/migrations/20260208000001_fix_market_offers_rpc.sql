-- Migration: fix_market_offers_rpc_and_aums_tenant
-- Description: Deploy missing get_market_best_offers RPC and initialize AUMS tenant with finance routing config.
...
-- 1. Restore get_market_best_offers RPC (v3 with bundles)
...
-- 2. Initialize AUMS Tenant
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM public.id_tenants WHERE type = 'AUMS') THEN
        INSERT INTO public.id_tenants (id, name, slug, type, status, config)
        VALUES (
            gen_random_uuid(),
            'AUMS Central',
            'aums-central',
            ...
            'ACTIVE',
            jsonb_build_object(
                'financeRouting', jsonb_build_object(
                    'Monday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33'),
                    'Tuesday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33'),
                    'Wednesday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33'),
                    'Thursday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33'),
                    'Friday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33'),
                    'Saturday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33'),
                    'Sunday', jsonb_build_object('p1', '9bc62145-878d-45a4-9674-090ad0605156', 'p2', '1b6bdb20-e798-4394-891f-f8583f738608', 'p3', '74f65c42-09aa-40b3-be96-f0c8bbc74f33')
                )
            )
        );
    END IF;
