-- Fix quote->booking conversion when crm_quotes.commercials/customer payload is JSON (not JSONB).
-- Prevents: "COALESCE could not convert type jsonb to json"
...
BEGIN
    ...
    -- Cast to json explicitly so COALESCE operands remain same type.
